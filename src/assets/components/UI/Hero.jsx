        ...
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          ...
          <div className="w-full md:basis-1/2">
            ...
            >
              ...
              <a
                href="#portofolio"
                className="text-smallTextColor font-[450] text-[16px] border-b border-solid border-smallTextColor"
              >
                See Portofolio
              </a>
            </div>
            ...
            >
              ...
              Informatics Engineering graduate driven to enhance skills and gain
              impactful, real-world experience through continuous learning and
          ...
          <div className="md:basis-1/5 flex justify-between text-center mt-10 flex-wrap gap-3 md:mt-0 md:flex-col md:justify-end md:text-end">
            <div className="mb-10">
              ...
              <h4 className="text-headingColor font-[500] text-[16px]">
                Year of experiences
              </h4>
            </div>
            <div className="mb-10">
