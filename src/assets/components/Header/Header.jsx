            ...
            <div className='flex items-center justify-between'>
                ...
                <div className="menu" ref={menuRef} onClick={toggleMenu} >
                    <ul className='flex item-center gap-10'>
                        <li>
                            <a href="#about" className='text-smallTextColor font-[400]'
                            onClick={handleClick}>
                                About
                            </a>
                        </li>
                        <li>
                            <a href="#services" className='text-smallTextColor font-[400]'
                            onClick={handleClick}>
                                Services
                            </a>
                        </li>
                        <li>
                            <a href="#portofolio" className='text-smallTextColor font-[400]'
                            onClick={handleClick}>
                                Portofolio
                            </a>
                        </li>
                        <li>
                            <a href="#contact" className='text-smallTextColor font-[400]'
                            onClick={handleClick}>
                                Contact
                            </a>
                        </li>
